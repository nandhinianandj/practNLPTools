...
def test():
    annotator=Annotator()
    print(annotator.getBatchAnnotations(["He killed the man with a knife and murdered him with a \
                                            dagger.","He is a good boy."],dep_parse=True))
    print(annotator.getAnnotations("Republican candidate George Bush was \
            great.",dep_parse=True)['dep_parse'])
    print(annotator.getAnnotations("Republican candidate George Bush was \
                    great.",dep_parse=True)['chunk'])
